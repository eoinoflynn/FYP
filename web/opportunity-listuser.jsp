	...
	<div class="row">
           <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <form action="../opportunity/listLocation" method="post">
...
<c:forEach var="opportunity" items="${listOpportunity2}">
<tr bgcolor="#E0FFFF">
							...
							<td><c:out value="${opportunity.payment}" /></td>
                                                        ...
                                                        <td><a class='btn btn-info btn-xs' href="apply?id=<c:out value='${opportunity.id}' />"><span class="glyphicon glyphicon-edit"></span> <font size="4"> Apply</font></a></td>
</tr>
</c:forEach>
