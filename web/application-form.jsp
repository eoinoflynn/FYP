    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form"> 
				...
				<c:if test="${application != null}">
					<input type="hidden" name="appid" value="<c:out value='${application.appid}' />" />
				</c:if>
                                        
				<div class="dragArea row"> 
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="activity">
                             <input <input type="text"
						value="<c:out value='${application.activity}' />"
						...
						name="status" id="email-form6-k" placeholder="Change status to accepted/declined">
                        </div>
                       <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="message">
                           <input type="text"
						value="<c:out value='' />" class="form-control"
						name="message" id="email-form6-k" placeholder="Insert message for applient">
                        </div>
                        
                        <div class="col-auto mbr-section-btn align-center"><button type="submit" class="btn btn-primary display-4">Update</button></div>
				</form>
			</div>
		</div>
	</div>
