...
<body>
  ...
  <section class="menu menu2 cid-snY7U20ZfF" once="menu" id="menu2-1">
...
<section class="header7 cid-snY7A0h9rE mbr-fullscreen" id="header7-0">
    ...
    <div class="text-right container">
        <div class="row justify-content-end">
            <div class="col-12 col-lg-5">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>DogTime</strong></h1>
...
<section class="features4 cid-snYblKVvGx" id="features4-5">
        ...
        <div class="row mt-4">
            ...
            <div class="item features-image ?ol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/jamie-street-wco2pwluq3u-unsplash.jpg" alt="" title="" data-slide-to="0">
                    </div>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/jamie-street-wfbkj9ilgnq-unsplash.jpg" alt="" title="" data-slide-to="1">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>Create Opportunities</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/jamie-street-utre5dcgeyg-unsplash.jpg" alt="" title="" data-slide-to="2">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>View Opportunities</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">View available minding and walking opportunities</p>
                    </div>
                  ...
                  <!--  <div class="mbr-section-btn item-footer mt-2"><a class="btn item-btn btn-black display-7" href="listOpportunityOwner?name=<c:out value ='${owner.name}' />">start</a></div> -->
                </div>
            </div>
...
<section class="image1 cid-snYn52cksh" id="image1-6">
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6">
                <div class="image-wrapper">
                    <img src="assets/images/jamie-street-wfbkj9ilgnq-unsplash.jpg" alt="Mobirise">
            ...
            <div class="col-12 col-lg">
                <div class="text-wrapper">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                        Here at DogTime&nbsp;we present dog owners the ability to quickly and easily find a dog minder/walker who is reliable and trustworthy.<br><br>Here at DogTime we present dog lovers the opportunity to work with friendly dogs with flexible hours chosen by themselves!&nbsp;<br></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="contacts1 cid-snYpliX0Yf" id="contacts1-7">
    ...
    <div class="container">
        <div class="mbr-section-head">
            ...
            <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">We always love to hear from you!</h4>
        </div>
            ...
            <div class="card col-12 col-lg-6">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <h5 class="link mbr-fonts-style display-7"><a href="mailto:eoinpoflynn@gmail.com" class="text-primary">Send us an
                                email</a>
                        </h5>
                    </div>
                </div>
...
</section><section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/v" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a><p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/q" style="color:#aaa;">The site</a> was built with Mobirise website template</p></section><script src="assets/web/assets/jquery/jquery.min.js"></script>  <script src="assets/popper/popper.min.js"></script>  <script src="assets/tether/tether.min.js"></script>  <script src="assets/bootstrap/js/bootstrap.min.js"></script>  <script src="assets/smoothscroll/smooth-scroll.js"></script>  <script src="assets/dropdown/js/nav-dropdown.js"></script>  <script src="assets/dropdown/js/navbar-dropdown.js"></script>  <script src="assets/touchswipe/jquery.touch-swipe.min.js"></script>  <script src="assets/theme/js/script.js"></script>  
