	...
	<div class="row">
           <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <form action="../application/listLocation" method="post">
...
<tr bgcolor="#E0FFFF">
							...
							<td>
								<a class="btn btn-danger btn-xs" href="deleteuser?appid=<c:out value='${application.appid}' />"><span class="glyphicon glyphicon-remove"></span><font size="4"> Remove</font></a>
</tr>
</c:forEach>
