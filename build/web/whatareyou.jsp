    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="./whatareyou.jspp">Login</a></div>
            </div>
        </div>
    </nav>
</section>
        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>I am a dog owner</strong></h5>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-6">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>I want to become a dog sitter</strong></h5>
