    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black text-primary display-4" href="../homepageowner2.jsp" style="font-size: 18px;">
	...
	<div class="row">
           <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <form action="../application/listLocationOwner" method="post">
...
<tr bgcolor="#E0FFFF">
							...
							<td><c:out value="${application.activity}" /></td>
							<td><c:out value="${application.location}" /></td>
							<td><c:out value="${application.payment}" /></td>
                                                        <td><c:out value="${application.sdate}" /></td>
                                                        <td><c:out value="${application.edate}" /></td>
                                                        <td><c:out value="${application.length}" /></td>
                                                        <td><c:out value="${application.dname}" /></td>
                                                        <td><c:out value="${application.dbreed}" /></td>
                                                        <td><c:out value="${application.dage}" /></td>
                                                        <td><c:out value="${application.additional}" /></td>
                                                        <td><c:out value="${application.name}" /></td>
                                                        <td><c:out value="${application.userName}" /></td>
                                                        <td><c:out value="${application.status}" /></td>
                                                        <td><c:out value="${application.message}" /></td>
							<td><a class='btn btn-info btn-xs' href="edit?appid=<c:out value='${application.appid}' />"><span class="glyphicon glyphicon-edit"></span> <font size="4"> Edit</font></a>
							
								<a class="btn btn-danger btn-xs" href="delete?appid=<c:out value='${application.appid}' />"><span class="glyphicon glyphicon-remove"></span> <font size="4"> Remove</font> </a>
</tr>
</c:forEach>
