<%-- 
    ...
    Created on : 05-Mar-2021, 18:09:36
    Author     : eoinp
--%>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form"> <!-- data-form-type="formoid", was inside tag to left -->
                 <form action="loginowner" method="post" class="mbr-form form-with-styler mx-auto"> <!-- data-form-title="Form Name", was inside tag to left -->
               ...
               <!-- <div class="">
                    ...
                    <div class="dragArea row"> 
                        ...
                        &nbsp;
                        <div class="col-auto mbr-section-btn align-center"><a class="btn btn-primary display-4" href="loginowner.jsp">Login</a></div>
                    </div>
